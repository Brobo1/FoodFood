    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealResturant", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MealResturant_Meal_MealId",
                        column: x => x.MealId,
                        principalTable: "Meal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealResturant_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantRatingId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealResturant_MealId",
                table: "MealResturant",
                column: "MealId");

            migrationBuilder.CreateIndex(
                name: "IX_MealResturant_RestaurantId",
                table: "MealResturant",
                column: "RestaurantId");
